...
class Layer:
    def __init__(self, previous_layer: Optional[Layer], num_neurons: int,
        ...
        #  все следующее может быть одним большим списком для понимания, но так получается немного длиннее
    ...
    # должен вызываться только на выходном уровне
    ...
    # не должен вызываться на выходном уровне
